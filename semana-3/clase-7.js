...
function mostrarDatosEnPerfil(listado) {
    ...
    console.log(acc); 
    const cantAlbum = document.querySelector('.perfil #cant-albums');
    cantAlbum.innerText = ('albumes');
    */
    ...
    spanCantidad = document.getElementById('cant-albums');
    spanFavs = document.getElementById('cant-favoritos');
    
    listado.forEach((item) => {
        item.like===true ? cantFavs++ : 0;
    })
    
    cantAlbumes === 1 ? spanCantidad.innerHTML=cantAlbumes + " album" : spanCantidad.innerHTML=cantAlbumes + " albumes";
    cantFavs === 1 ? spanFavs.innerHTML=cantFavs + " favorito" : spanFavs.innerHTML=cantFavs + " favoritos";
    /*
    if (cantAlbumes === 1) {
        spanCantidad.innerHTML=cantAlbumes + " album"
    } else {
        spanCantidad.innerHTML=cantAlbumes + " albumes";
    }

    if (cantFavs === 1) {
        spanFavs.innerHTML=cantFavs + " favorito"
    } else {
        spanFavs.innerHTML=cantFavs + " favoritos";
    }
*/
    console.log(spanCantidad);
    console.log(spanFavs);
