...
function conocerMusica() {
    let respuesta=confirm("Desea conocer más música?");
    const mensaje = document.querySelector('.perfil');
    if(respuesta){
        window.open("https://open.spotify.com/", "_blank");
    } else {
        mensaje.innerHTML+=`<p>Usuario oficial de Spotifront</p>`;
    }
...
setTimeout(conocerMusica(), 12000);