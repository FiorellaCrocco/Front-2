...
function eliminarAlbum() {
    ...
    window.addEventListener('keydown', (e)=> {
        ...
        if (e.key ==='f') {
            ...
            const posicionBuscando = albumesFamosos.findIndex (obj=>obj.nombre === album)
            console.log(posicionBuscando);
            if (posicionBuscando !== -1) {
                albumesFamosos.splice(posicionBuscando, 1);
