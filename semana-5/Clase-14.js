...
function botonCerrarSesion() {
    ...
    let boton = document.querySelector(".user");
    boton.innerHTML += `<button type="submit" class="user-boton">Cerrar sesión</button>`
    
    boton.addEventListener('click', function () {
        let respuesta = confirm("¿Seguro desea cerrar sesión?");
        if(respuesta){
            localStorage.clear();
